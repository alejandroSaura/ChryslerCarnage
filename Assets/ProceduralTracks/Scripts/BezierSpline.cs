...
{
    // Mark the spline for making paths
...
public class BezierSpline : MonoBehaviour
{
    ...
    public BezierData GetData()
    {
        ...
        data.north_south = north_south;
        data.north_east = north_east;
        data.north_west = north_west;

        data.south_east = south_east;
        data.south_west = south_west;

        data.east_west = east_west;
    ...
    public void SetData(BezierData data)
    {
        ...
        north_east = data.north_east;
        north_west = data.north_west;

        south_east = data.south_east;
        south_west = data.south_west;
